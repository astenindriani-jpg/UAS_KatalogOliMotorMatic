...
![Halaman Utama Portrait](screenshot/halaman_utama_potret.png)

### 2. Halaman Utama (Landscape)
![Halaman Utama Landscape](screenshot/halaman_utama_Land.png)

### 3. Halaman Katalog
![Halaman Katalog](screenshot/halaman_katalog.png)

### 4. Halaman Tambah Produk (Portrait)
![Halaman Tambah Produk Portrait](screenshot/halaman_tambah_produk_potret.png)

### 5. Halaman Tambah Produk (Landscape)
![Halaman Tambah Produk Landscape](screenshot/halaman_tambah_produk_Land.png)

### 6. Halaman Detail Katalog
![Halaman Detail Katalog](screenshot/halaman_detail_katallog.png)

### 7. Screenshot Hasil Pencarian Data
![Katalog by Nama](screenshot/halaman_katalog_by_nama.png)

### 8. Screenshot Hasil Pengurutan Data
![Katalog by Harga](screenshot/halaman_katalog_by_harga.png)
